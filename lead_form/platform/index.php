...
if (!empty($_POST))
{
    ...
    $status = TRUE;
    //echo '<pre>';var_dump($status);var_dump($_POST);exit;
...
<head>
    ...
    <![endif]-->
    <link rel="preload" href="css/font/Mukta-Bold.woff" as="font" type="font/woff" crossorigin>
    <link rel="preload" href="css/font/Mukta-Light.woff" as="font" type="font/woff" crossorigin>
    ...
    })(window,document,'script','dataLayer','GTM-W849PN6');</script>
    <!-- End Google Tag Manager -->
</head>

<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W849PN6"
    height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
    <header>
        <div class="hero-banner owl-carousel">
            <div class="item">
                <picture class="hero-desk">
                    <source srcset="images/landing-page-banner1.webp" type="image/webp">
                    <source srcset="images/landing-page-banner1.jpg" type="image/jpeg"> 
                    <img src="images/landing-page-banner1.jpg" alt="Swaraj Tractors">
                </picture>
                <picture class="hero-mobile">
                    <source srcset="images/landing-page-mobile-banner1.webp" type="image/webp">
                    <source srcset="images/landing-page-mobile-banner1.jpg" type="image/jpeg"> 
                    <img src="images/landing-page-mobile-banner1.jpg" alt="Swaraj Tractors">
                </picture>
            </div>
            <div class="item">
                <picture class="hero-desk">
                    <source srcset="images/landing-page-banner2.webp" type="image/webp">
                    <source srcset="images/landing-page-banner2.jpg" type="image/jpeg"> 
                    <img src="images/landing-page-banner2.jpg" alt="Swaraj Tractors">
                </picture>
                <picture class="hero-mobile">
                    <source srcset="images/landing-page-mobile-banner2.webp" type="image/webp">
                    <source srcset="images/landing-page-mobile-banner2.jpg" type="image/jpeg"> 
                    <img src="images/landing-page-mobile-banner2.jpg" alt="Swaraj Tractors">
                </picture>
            </div>
        </div> 
    </header>
